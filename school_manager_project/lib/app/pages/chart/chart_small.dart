...
// class ChartSmall extends StatelessWidget {
//   const ChartSmall({super.key});
...
//                     ),
//                   ),
//                   SizedBox(width: 600, height: 200, child: SimpleBarChart.withSampleData()),
//                   const SizedBox(height: 30),
//                   SizedBox(width: 600, height: 200, child: GroupedBarChart.withSampleData()),
//                   const SizedBox(height: 30),
//                   SizedBox(width: 600, height: 200, child: StackedHorizontalBarChart.withSampleData()),
//                   const SizedBox(height: 30),
//                   SizedBox(width: 600, height: 200, child: HorizontalBarLabelChart.withSampleData()),
//                   const SizedBox(height: 30),
//                   SizedBox(width: 600, height: 200, child: VerticalBarLabelChart.withSampleData()),
//                   const SizedBox(height: 30),
//                   SizedBox(width: 600, height: 200, child: GroupedFillColorBarChart.withSampleData()),
//                   const SizedBox(height: 30),
//                   SizedBox(width: 600, height: 200, child: HorizontalPatternForwardHatchBarChart.withSampleData()),
//                   const SizedBox(height: 30),
//                   SizedBox(width: 600, height: 200, child: CustomRoundedBars.withSampleData()),
//                 ],
//               ),
//             ),
//             Container(
